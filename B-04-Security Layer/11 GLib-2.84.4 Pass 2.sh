...
main () {
	...
	echoL "Downloading Glib (2.84.4) Pass 2..."
	sleep 2
	...
	echoL "Unpack Glib (2.84.4) Pass 2..."
	sleep 2
	cd /sources
	rm -fR glib-2.84.4
	...
	echoL "Building Glib (2.84.4) Pass 2..."
	sleep 2
	...
	echoL "Installing Glib (2.84.4) Pass 2..."
	sleep 2
	ninja install
	...
	cd /sources
	rm -fR glib-2.84.4
	rm -vfR /usr/include/glib-2.0.old
	echoL "Exiting..."
}
