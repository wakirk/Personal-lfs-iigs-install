...
main () {
	...
	echoL "Downloading FreeType (2.13.3) Pass 2..."
	sleep 2
	...
	echoL "Unpack FreeType (2.13.3) Pass 2..."
	sleep 2
	cd /sources
	...
	echoL "Building FreeType (2.13.3) Pass 2..."
	sleep 2
	...
	echoL "Installing FreeType (2.13.3) Pass 2..."
	sleep 2
	make install
