	19. xf86-input-libinput	xf86-input-libinput — Xorg input driver that connects Xorg to libinput.
...
https://www.linuxfromscratch.org/blfs/view/stable/x/x7driver.html
