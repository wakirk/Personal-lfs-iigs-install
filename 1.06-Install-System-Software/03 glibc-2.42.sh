...
main () {
	...
	../bash/Download.sh https://ftp.gnu.org/gnu/glibc/glibc-2.42.tar.xz glibc-2.42.tar.xz
	cp ../Packages/glibc-2.42.tar.xz /sources

	sleep 2
	echoL "Downloading FHS Patch..."
	../bash/Download.sh https://www.linuxfromscratch.org/patches/lfs/12.4/glibc-2.42-fhs-1.patch glibc-2.42-fhs-1.patch
	cp ../Packages/glibc-2.42-fhs-1.patch /sources

	sleep 2
	echoL "Downloading Timezone Data..."
	../bash/Download.sh https://www.iana.org/time-zones/repository/releases/tzdata2025b.tar.gz tzdata2025b.tar.gz
